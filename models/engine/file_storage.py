...
test_file_storage.py'])
    ...
    def test_file_storage_function_docstrings(self):
        """Test for the presence of docstrings in FileStorage methods"""
        for function in self.file_storage_functions:
...
class TestFileStorage(unittest.TestCase):
    ...
    def test_new(self):
        ...
        storage = FileStorage()
        saved_objects = FileStorage._FileStorage__objects
        FileStorage._FileStorage__objects = {}
        test_dict = {}
        for class_name, class_instance in classes.items():
            with self.subTest(class_name=class_name, class_instance=class_instance):
                instance = class_instance()
                instance_key = instance.__class__.__name__ + "." + instance.id
                storage.new(instance)
                test_dict[instance_key] = instance
                self.assertEqual(test_dict, storage._FileStorage__objects)
        FileStorage._FileStorage__objects = saved_objects
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as f:
            json_data = f.read()
        self.assertEqual(json.loads(string), json.loads(json_data))
class TestFileStorageDocs(unittest.TestCase):
    """Tests to check the documentation and style of FileStorage class"""
    @classmethod
    def setUpClass(cls):
